...
\fancyhead[L]{
	...
	\begin{textblock*}{5cm}(24mm,16mm)
		...
		\textbf{\ExtractFirstChar{\theCommittee}/RES/\theResNum\text{ }(\theResYear)}
	\end{textblock*}
...
\begin{flushleft}
	...
	\begin{textblock*}{5cm}(158mm,1.4cm)
		...
		\ExtractFirstChar{\theCommittee}\fontsize{11}{0}\selectfont/RES/\theResNum\text{ }(\theResYear)
	\end{textblock*}
	...
	\end{textblock*}
  	...
  	\begin{tikzpicture}[remember picture, overlay]
    	...
    	{\includegraphics[scale=0.065]{images/un_logo.png}}; % scale the image to 50% of its original size
	\end{tikzpicture}
	...
	\Large\textbf{Resolution \theResNum\text{ }(\theResYear)} % add title here
